...
| Visual review     | `npm run gallery`: fixed beats captured from the production build on every project, published as a CI artifact; optional manual Pages publication                                         | `adr/0006-gallery-review-artefact.md`    |
