...
| **B Pilot art**             | The 17 portraits, one hero (Kaya), one enemy (bandit thug), the fire effect set, one display font                                                                                                                                                                 | A2, art bible | Pilot assets pass `validateContent` and the QA checklist on a real iPad; regeneration rounds per hero recorded        |
