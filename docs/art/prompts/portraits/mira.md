# Portrait: Elder Mira — `portrait.mira`

|              |                                                                                                                  |
| ------------ | ---------------------------------------------------------------------------------------------------------------- |
| **Palette**  | `earth` — base `#6f9e4c`, light `#a8c686`, dark `#456330`, accent `#e0e8b0`, ink `#1b1410`, background `#f4e9d8` |
| **Deliver**  | `art/raw/portraits/mira.png` (1024×1024 or larger, PNG)                                                          |
| **Ships as** | `public/art/portraits/mira.png` (512×512)                                                                        |
| **Manifest** | `'portrait.mira': { kind: 'image', url: 'art/portraits/mira.png', palette: 'earth' }`                            |

## Who

A woman in her seventies with a deeply lined, unbending face, white hair in a tight bun, and eyes that have already priced you. Weathered brown skin.

A heavy shawl in moss green and ochre (base #6f9e4c, shadow #456330) over a dark tunic, a plain carved stone pendant on a cord at the throat.

One hand resting on the head of a walking stick at the bottom edge of the frame.

## Signature

The white bun and the pendant. Authority without ornament.
...
Run `checklist.md` before committing. For this portrait in particular: The white bun and the pendant. Authority without ornament.
