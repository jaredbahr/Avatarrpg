...
A single curl of wind drawn as one flat pale spiral beside his raised left hand on the viewer’s right. The left palm faces the viewer: index and middle raised, ring and little curled separately on the viewer’s right, and one thumb rooted on the viewer’s left across the curled fingers.
