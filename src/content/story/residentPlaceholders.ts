 ...
 *
 * Hanru's watch needs a bound NpcDef before its resident record validates
 * (a slot's `npc`, and the fallback's, must name one), and an NpcDef needs a
 * story node. These nodes exist only for
