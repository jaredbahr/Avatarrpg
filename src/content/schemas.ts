  ...
  .object({
    ...
    scene: z
      .object({
        ...
        // already paints eight pieces underneath. Thirty-two leaves room for
        // that and one more authored region without letting a scene quietly
        // grow into an unbounded pile of ground draws.
