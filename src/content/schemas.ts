  ...
  .object({
    ...
    scene: z
      .object({
        ...
        // decals, and the village's north fringe, canal banks and exterior
        // apron. The bound still exists so a scene cannot quietly grow into an
        // unbounded pile of ground draws.
